...
public enum MessagesLocale implements IDataAccessor {
    ...
    MATCH_RESPAWN_TITLE_FOOTER("MATCH.RESPAWN_TITLE.FOOTER", DataType.STRING, ""),
    ...
    MATCH_BOXING_HIT_DIFFERENCE_HIGHER("MATCH.HIT_DIFFERENCE_PLACEHOLDER.HIGHER", DataType.STRING,
            "&a(<hit-difference> Hits)"),
    MATCH_BOXING_HIT_DIFFERENCE_EQUAL("MATCH.HIT_DIFFERENCE_PLACEHOLDER.EQUAL", DataType.STRING,
            "&e(<hit-difference> Hits)"),
    MATCH_BOXING_HIT_DIFFERENCE_LOWER("MATCH.HIT_DIFFERENCE_PLACEHOLDER.LOWER", DataType.STRING,
    ...
    KIT_EDITOR_START("KIT_EDITOR.START", "This is sent when the player starts editing a kit.", DataType.STRING_LIST,
            "&bYou are now editing &f<kit>&b!"),
    KIT_EDITOR_SAVED("KIT_EDITOR.SAVED", "This is sent when the player saves a kit.", DataType.STRING_LIST,
            "&aKit layout has been saved for &f<kit>&a."),
    KIT_EDITOR_CLOSED("KIT_EDITOR.CLOSED", "This is sent when the player closes the editor without saving.", DataType.STRING_LIST,
            "&cEditor closed without saving."),
    KIT_EDITOR_RESET("KIT_EDITOR.RESET", "This is sent when the player resets a kit.", DataType.STRING_LIST,
            "&aKit has been reset."),
    KIT_EDITOR_ALREADY_OPEN("KIT_EDITOR.ALREADY_OPEN", "This is sent when the player tries to open the editor while already editing.", DataType.STRING_LIST,
            "&cYou are already editing a kit!"),
    KIT_EDITOR_REFILL_SAVED("KIT_EDITOR.REFILL.SAVED", "This is sent when refill items are saved.", DataType.STRING_LIST,
            "&aRefill items saved for &f<kit>&a."),
    KIT_EDITOR_REFILL_CLEARED("KIT_EDITOR.REFILL.CLEARED", "This is sent when refill items are cleared.", DataType.STRING_LIST,
            "&aRefill items cleared for &f<kit>&a."),
    KIT_EDITOR_REFILL_EMPTY("KIT_EDITOR.REFILL.EMPTY", "This is sent when there are no refill items to view.", DataType.STRING_LIST,
            "&cNo refill items set for &f<kit>&c."),
    ...
    SPECTATE_STARTED("MATCH.SPECTATE.STARTED", DataType.STRING_LIST,
    ...
    PARTY_PRIVACY_CLOSED("PARTY.PRIVACY.CLOSED", DataType.STRING, "Closed"),
    ...
    PARTY_HELP("PARTY.HELP", "Message sent on /party help", DataType.STRING_LIST,
            ...
            "&b/party advertise",
            "&b/party chat <message>",
            "&b/pc <message>",
            "&b/pc &7(toggle party chat)",
            " "),
    PARTY_EXPIRED("PARTY.EXPIRED", DataType.STRING_LIST, "&cYour party request to &c<player> &chas expired."),
    PARTY_CHAT_FORMAT("PARTY.CHAT_FORMAT", DataType.STRING, "&9[Party] &f<player>: &7<message>"),
    PARTY_CHAT_NOT_IN_PARTY("PARTY.CHAT_NOT_IN_PARTY", DataType.STRING_LIST, "&cYou are not in a party."),
    PARTY_CHAT_TOGGLE_ON("PARTY.CHAT_TOGGLE_ON", DataType.STRING_LIST, "&aParty chat enabled. &7Your messages will be sent to party chat."),
    PARTY_CHAT_TOGGLE_OFF("PARTY.CHAT_TOGGLE_OFF", DataType.STRING_LIST, "&cParty chat disabled. &7Your messages will be sent to public chat."),
    ...
    public void update() {
        DUEL_REQUEST_RECEIVER.set(
                DUEL_REQUEST_RECEIVER.getStringList().stream().map(
                        str -> str.replace("<hover:show_text:'&aClick to accept duel request'><click:run_command:'/duel accept-uuid <uuid>'>&a&l(ACCEPT)</click></hover>", "<accept><hover:show_text:'&aClick to accept duel request'>&a&l(ACCEPT)</hover></accept>")
                                .replace("<hover:show_text:'&cClick to deny duel request'><click:run_command:'/duel deny-uuid <uuid>'>&a&l(DENY)</click></hover>", "<deny><hover:show_text:'&cClick to deny duel request'>&a&l(DENY)</hover></deny>")
                ).toList()
        );
